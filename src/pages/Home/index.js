...
export default function Home({ navigation, route }) {
  ...
  return (
    ...
    <View style={{padding:10, flexDirection:"row", justifyContent:'space-between', backgroundColor:colors.primary,
    ...
    <View style={{alignItems:"center", justifyContent:"center", alignSelf:"center"}}>
        <TouchableNativeFeedback style={{alignItems:"center", justifyContent:"center", alignSelf:"center"}}>
...
{/* 1 */}
<TouchableNativeFeedback onPress={() => navigation.navigate('DashboardPoint')}>
  <View style={{
  ...
  <Image source={require('../../assets/dashboardpoint.png')} style={{
    height:50, width:50,
    alignSelf:"center",
    alignItems:"center",
    marginTop:15,
  ...
  <Text style={{color:"black", fontFamily:fonts.primary[600], fontSize: MyDimensi/5,
...
{/* 2 */}
<TouchableNativeFeedback onPress={() => navigation.navigate('ScoreAudit')}>
  <View style={{
    backgroundColor:colors.secondary,
    padding:10,
    width:100,
  ...
  <Image source={require('../../assets/scoreaudit.png')} style={{
    height:50, width:50,
    alignSelf:"center",
    alignItems:"center",
    marginTop:15,
...
<TouchableNativeFeedback onPress={() => navigation.navigate('DashboardCategory')}>
  ...
  <Image source={require('../../assets/dashboardcategory.png')} style={{
    height:50, width:50,
    alignSelf:"center",
    alignItems:"center",
    marginTop:15,
...
<TouchableNativeFeedback>
  ...
  <Image source={require('../../assets/scoreaudit.png')} style={{
    ...
    <Text style={{color:"white", fontFamily:fonts.primary[400], fontSize: MyDimensi/6.8,
